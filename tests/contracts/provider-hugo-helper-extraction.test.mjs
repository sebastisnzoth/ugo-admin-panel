...
test('provider Hugo delegates interpretation to Gemini Live and executes only declared UGO tools',async()=>{
 ...
 for(const tool of ['provider_get_current_job','provider_mark_en_route','provider_mark_arrived','provider_start_job','provider_complete_job'])assert.match(bridge,new RegExp(tool))
