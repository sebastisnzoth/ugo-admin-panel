...
hooks = Path('src/hooks/useAdminData.ts')
...
replace_between(
    'src/mvp/AdminNativeModules.tsx',
...
replace_between(
    'src/mvp/AdminSystemSettings.tsx',
