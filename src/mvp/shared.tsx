...
export function LoadingScreen({label='Abriendo UGO…'}:{label?:string}){return <main className="mvp-loading ugo-ds-loading ugo-app-splash" role="status" aria-live="polite" aria-label={label}><div className="ugo-splash-glow" aria-hidden="true"/><section className="ugo-splash-content"><div className="ugo-splash-logo" aria-hidden="true">UG<span>O</span></div><div className="ugo-splash-mark" aria-hidden="true"><i/><i/><i/></div><p>{label}</p><div className="ugo-splash-progress" aria-hidden="true"><span/></div><small>Un pedido. Un profesional. Sin vueltas.</small></section></main>}
