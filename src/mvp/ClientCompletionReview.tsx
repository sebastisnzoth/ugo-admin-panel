...
export function ClientCompletionReview(){
 ...
 return <section style={{position:'fixed',zIndex:118,left:'50%',bottom:'max(18px,env(safe-area-inset-bottom))',transform:'translateX(-50%)',width:'min(680px,calc(100vw - 24px))',maxHeight:'78dvh',overflowY:'auto',background:'#fff',border:'1px solid #e7ece9',borderRadius:24,padding:16,boxShadow:'0 24px 70px rgba(15,23,42,.20)'}}>
