...
export function ProviderProfileScreen(){
 ...
 return <section className="provider-screen provider-profile-complete" aria-labelledby="provider-profile-title">
  ...
  <div className="provider-settings-list">
   <details className="provider-setting" open><summary><span className="provider-setting-icon">⌁</span><div><strong>Servicios y zona</strong><small>Qué hacés y dónde trabajás</small></div></summary><div className="provider-setting-content"><p>{p.categoria_principal_id?'Categoría profesional configurada.':'Falta configurar tu categoría principal.'}</p><p>{p.ciudad_base||'Ciudad sin definir'} · radio de {p.zona_radio_km||15} km</p><button type="button" onClick={()=>setEditing(true)}>Editar información</button></div></details>
