...
export function ClientLiveTracking(){
 ...
 return <aside className="ugo-live-tracking" aria-live="polite"><header><div><small>SERVICIO #{service.numero}</small><strong>Profesional en camino</strong><p>Seguimiento exacto sólo durante el traslado.</p></div><span className="ugo-live-dot">●</span></header><ClientActiveMap supabase={supabase} serviceId={service.id}/></aside>
}
