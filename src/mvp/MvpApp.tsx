...
import'./stitch-client-v2.css'
import'./stitch-web.css'
...
export function MvpApp(){
 ...
 if(app==='client')return <ClientFlowProvider><ClientRoot demoPayment={params.get('demo')==='1'}/></ClientFlowProvider>
