  ...
  <section className="ugo-home-layout">
   <div className="ugo-home-hero">
    ...
    <div className="ugo-home-search-wrap">
     <label className="ugo-home-search"><span>⌕</span><input ref={searchRef} value={query} onChange={e=>{setQuery(e.target.value);setShowAll(false)}} placeholder="¿Qué servicio necesitás?"/></label>
