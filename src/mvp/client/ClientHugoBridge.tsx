...
export function ClientHugoBridge(){
 ...
 return <ClientVoiceHugoDock accessToken={session.access_token} service={service} services={services} availableOffers={offersPending} paymentStatus={paymentStatus} clientActions={flow.actions} onIntent={flow.publishHugoIntent} onNavigateHome={()=>flow.navigate('home')}/>
}
