...
export function ClientPremiumHome(){
 ...
 return <main className="ugo-client-premium-home">
  <header><div><strong>U.GO</strong><span>● {place}</span></div><button type="button" aria-label="Abrir perfil" onClick={()=>flow.actions.openProfile()}>{profile.nombre?.slice(0,1).toUpperCase()||'U'}</button></header>
  ...
  <section className="ugo-client-home-map" aria-label="Tu zona"><div ref={mapEl}/><div className="ugo-client-home-map-shade"/></section>
