...
export function ClientNeedScreen(){
 ...
 const[categories,setCategories]=useState<Category[]>([]),[description,setDescription]=useState(''),[message,setMessage]=useState('')
 ...
 const continueJourney=()=>{
  ...
  // Keep the real guided composer as the next stage until screen 3 is migrated.
  window.dispatchEvent(new CustomEvent(UGO_UI_EVENTS.clientHugoText,{detail:{text:value,send:true}}))
 }
