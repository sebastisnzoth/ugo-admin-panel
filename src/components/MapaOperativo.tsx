...
export function SecMapaOperativo(){
  ...
  return <div style={{height:'100%',display:'flex',flexDirection:'column',overflow:'hidden'}}>
    <div style={{padding:'8px 14px',borderBottom:'1px solid #e5e7eb',display:'flex',gap:8,alignItems:'center',flexWrap:'wrap',background:'#fff',color:'#101828'}}>
    ...
    <div style={{flex:1,display:'flex',minHeight:0}}>
      <aside style={{width:210,background:'#fff',color:'#101828',borderRight:'1px solid #e5e7eb',padding:12,overflowY:'auto'}}>
