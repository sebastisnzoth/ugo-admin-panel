-- UGO TEST · Extend Sentinel server-side classification for client provider-radar sync failures.
...
begin
  ...
  v_checklist_code := case
    ...
    when p_action in ('client.request.matching','client.provider_radar.sync') then 'MATCH-ONLINE'
